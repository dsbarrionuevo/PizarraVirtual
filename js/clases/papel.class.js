function Papel(canvas) {
    ...
    this.agregarCapa = function(){
		var capa = new Capa(this.capas.length);//el orden de la capa esta definico por el length del array de capas
	...
	this.agregarCapa();
	this.ordenCapaActual = 0;//seteo como capa actual a la de fondo, recien insertada
}